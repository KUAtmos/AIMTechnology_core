...
* input parameters
    ...
    emax(ME,K)          'maximum allowable energy supply'
    emin(ME,K)          'minimum allowable energy supply'
    thmx(R,I,L,J)       'maximum allowable service share for service J'
    thmn(R,I,L,J)       'minimum allowable service share for service J'
    ...
    tumx(R,I,L)         'maximum quantity of new installation'
    tumn(R,I,L)         'minimum quantity of new installation'
    ...
    emax_t(ME,K,H)      'maximum allowable energy supply'
    emin_t(ME,K,H)      'minimum allowable energy supply'
    ...
    tumx_t(R,I,L,H)     'maximum installed quantity'
    tumn_t(R,I,L,H)     'minimum installed quantity'
...
* output parameters
    ...
    emax_t1(ME,K,H)     'maximum energy supply'
    emin_t1(ME,K,H)     'minimum energy supply'
