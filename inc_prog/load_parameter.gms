...
$load FL_IL,FL_ILJ,FL_ILK,FL_IK,FL_IJ,FL_INJ,FL_ILO,FL_ILR,FL_INTK,FL_INTJ,FL_NOTINT_K,FL_NOTINT_J,FL_DMPG,FL_DMPG2
$load serv_t,ge_t,gas_t,emax_t,emin_t,qmax_t,an_t,en_t,gam_t,sc_base,bn_t,br_t,go_t,thmx_t,thmn_t,chmx_t,chmn_t,ommx_t,ommn_t,sgmx_t,sgmn_t,tumx_t,tumn_t,romx_t,romn_t,phi_t,xi_t,scn_t,scr_t,v_year,alpha,tn,emtax_t,res_end_up,essc,tumx_dec
$gdxin
