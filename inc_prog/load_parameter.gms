...
$load serv_t,ge_t,gas_t,emax_t,emin_t,qmax_t,an_t,en_t,gam_t,sc_base,bn_t,br_t,go_t,thmx_t
$load thmn_t,chmx_t,chmn_t,ommx_t,ommn_t,sgmx_t,sgmn_t,tumx_t,tumn_t,romx_t,romn_t,kamx_t,kamn_t
$load phi_t,xi_t,scn_t,scr_t,v_year,alpha,tn,emtax_t,res_end_up,essc,tumx_dec
$gdxin
